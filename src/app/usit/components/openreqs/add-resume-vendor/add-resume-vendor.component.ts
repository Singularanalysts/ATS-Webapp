...
@Component({
  selector: 'app-add-resume-vendor',
   standalone: true,
    imports: [
      CommonModule,
      FormsModule,
  ...
  templateUrl: './add-resume-vendor.component.html',
  styleUrls: ['./add-resume-vendor.component.scss']
})
export class AddResumeVendorComponent {
  vendorObj = new Vms();
  ...
  dialogRef = inject(MatDialogRef<AddResumeVendorComponent>);
