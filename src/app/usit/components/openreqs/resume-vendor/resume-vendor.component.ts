...
import { AddResumeVendorComponent } from '../add-resume-vendor/add-resume-vendor.component';
import { AddResumeRecruiterComponent } from '../add-resume-recruiter/add-resume-recruiter.component';
interface Recruiter {
  recruitername: string;
  recruiteremail: string;
}
@Component({
  selector: 'app-resume-vendor',
    standalone: true,
    imports: [
      CommonModule,
      MatCardModule,
  ...
  templateUrl: './resume-vendor.component.html',
  styleUrls: ['./resume-vendor.component.scss']
})
export class ResumeVendorComponent {
dataSource: any;
