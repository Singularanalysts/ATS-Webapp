...
@Component({
  selector: 'app-post-job-free-requirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './post-job-free-requirements.component.html',
  styleUrls: ['./post-job-free-requirements.component.scss']
})
export class PostJobFreeRequirementsComponent implements OnInit {
