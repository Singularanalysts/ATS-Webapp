...
@Component({
  selector: 'app-joblift-requirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './joblift-requirements.component.html',
  styleUrls: ['./joblift-requirements.component.scss']
})
export class JobliftRequirementsComponent implements OnInit {
