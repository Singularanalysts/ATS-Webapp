...
@Component({
  selector: 'app-indeed-requirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './indeed-requirements.component.html',
  styleUrls: ['./indeed-requirements.component.scss']
})
export class IndeedRequirementsComponent implements OnInit {
