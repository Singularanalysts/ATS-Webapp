...
import { AddResumeVendorComponent, STATUS_TYPE } from '../add-resume-vendor/add-resume-vendor.component';
@Component({
  selector: 'app-add-resume-recruiter',
    standalone: true,
    imports: [
      CommonModule,
      FormsModule,
  ...
  templateUrl: './add-resume-recruiter.component.html',
  styleUrls: ['./add-resume-recruiter.component.scss']
})
export class AddResumeRecruiterComponent {
  ...
  dialogRef = inject(MatDialogRef<AddResumeRecruiterComponent>);
  ...
  navigateToAddVendor() {
    ...
    this.dialogServ.openDialogWithComponent(AddResumeVendorComponent, dialogConfig);
  }
