...
@Component({
  selector: 'app-adzuna-requirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './adzuna-requirements.component.html',
  styleUrls: ['./adzuna-requirements.component.scss']
})
export class AdzunaRequirementsComponent implements OnInit {
