...
@Component({
  selector: 'app-juju-requirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './juju-requirements.component.html',
  styleUrls: ['./juju-requirements.component.scss']
})
export class JujuRequirementsComponent implements OnInit {
