...
@Component({
  selector: 'app-recruit.net-requirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './recruit.net-requirements.component.html',
  styleUrls: ['./recruit.net-requirements.component.scss']
})
export class RecruitNetRequirementsComponent implements OnInit {
