...
@Component({
  selector: 'app-simplyhired-rquirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './simplyhired-rquirements.component.html',
  styleUrls: ['./simplyhired-rquirements.component.scss']
})
export class SimplyhiredRquirementsComponent implements OnInit {
