...
@Component({
  selector: 'app-snaprecruit-requirements',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './snaprecruit-requirements.component.html',
  styleUrls: ['./snaprecruit-requirements.component.scss']
})
export class SnaprecruitRequirementsComponent implements OnInit {
