...
@Component({
  ...
  styleUrls: ['./leave-of-absence.component.scss'],
...
export class LeaveOfAbsenceComponent implements OnInit, OnDestroy{
  ...
  deleteInterview(interview: any) {
    ...
    dialogConfig.disableClose = false;
    dialogConfig.panelClass = 'delete-leave-of-absence';
        ...
        if (dialogRef.componentInstance.allowAction) {
          ...
          .subscribe({next:(response: any) => {
            if (response.status == 'success') {
              this.getAll();
              dataToBeSentToSnackBar.message = 'Leave of Absence Immigrant Deleted successfully';
            } else {
