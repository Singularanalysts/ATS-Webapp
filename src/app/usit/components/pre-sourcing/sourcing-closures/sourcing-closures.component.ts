...
@Component({
  selector: 'app-sourcing-closures',
  standalone: true,
  imports: [
    MatSelectModule,
    MatTableModule,
  ...
  templateUrl: './sourcing-closures.component.html',
  styleUrls: ['./sourcing-closures.component.scss'],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  providers: [{ provide: MatPaginatorIntl, useClass: PaginatorIntlService }],
})
export class SourcingClosuresComponent
