...
@Component({
  selector: 'app-closure-count-list',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './closure-count-list.component.html',
  styleUrls: ['./closure-count-list.component.scss'],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  providers: [{ provide: MatPaginatorIntl, useClass: PaginatorIntlService }],
})
export class ClosureCountListComponent {
  constructor(
    @Inject(MAT_DIALOG_DATA) protected data: any,
    public dialogRef: MatDialogRef<ClosureCountListComponent>
  ) { }
  ...
  field = 'empty';
  companyType: string = '';
  // u.pseudoname,cm.companyname, i.flg, c.consultantno, c.consultantname,
  // c.consultantemail,c.contactnumber,vs.visa_status, s.submissionrate,
  // s.ratetype, s.endclient, s.implpartner ,
  // v.company as vendor,r.recruiter,r.email,r.usnumber
