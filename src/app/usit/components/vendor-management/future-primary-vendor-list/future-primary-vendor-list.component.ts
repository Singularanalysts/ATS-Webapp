...
@Component({
  selector: 'app-future-primary-vendor-list',
  standalone: true,
  imports: [
    MatTableModule,
    MatIconModule,
...
export class FuturePrimaryVendorListComponent implements OnInit {
  ...
  addVendor() {
    const actionData = {
      title: 'Add Future Primary Vendor',
      vendorData: null,
      actionName: 'add-future-primary-vendor',
    };
    const dialogConfig = new MatDialogConfig();
    dialogConfig.width = '62dvw';
    dialogConfig.disableClose = false;
    dialogConfig.panelClass = 'add-future-primary-vendor';
    dialogConfig.data = actionData;

    const dialogRef = this.dialogServ.openDialogWithComponent(
      AddFuturePrimaryVendorComponent,
      dialogConfig
    );
  ...
  editVendor(vendor: any) {
    const actionData = {
      title: 'Update Future Primary Vendor',
      vendorData: vendor,
      actionName: 'edit-future-primary-vendor',
    };
    const dialogConfig = new MatDialogConfig();
