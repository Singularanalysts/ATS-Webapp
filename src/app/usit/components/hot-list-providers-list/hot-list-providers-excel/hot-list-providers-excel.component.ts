...
@Component({
  selector: 'app-hot-list-providers-excel',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './hot-list-providers-excel.component.html',
  styleUrls: ['./hot-list-providers-excel.component.scss']
})

export class HotListProvidersExcelComponent implements OnInit {
  ...
  dialogRef = inject(MatDialogRef<HotListProvidersExcelComponent>);
  ...
  submit(id: number) {
    ...
    this.fileService.uploadHotListProvidersExcel(formData, id)
