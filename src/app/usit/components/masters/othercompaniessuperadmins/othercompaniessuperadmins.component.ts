...
@Component({
  selector: 'app-othercompaniessuperadmins',
  templateUrl: './othercompaniessuperadmins.component.html',
  styleUrls: ['./othercompaniessuperadmins.component.scss'],
   standalone: true,
    imports: [
      MatTableModule,
      MatIconModule,
...
export class OthercompaniessuperadminsComponent implements OnInit, AfterViewInit, OnDestroy {
